...
// the use of the constructors from BinaryTreeBasis
  ...
  protected void preorder(TreeNode t)
  {
    if(t!=null)
    {
  ...
  protected void postorder(TreeNode t)
  {
    if(t!=null)
    {
  ...
  public boolean duplicateCheck(BinarySearchTree otherTree) throws NullPointerException
  {
    return duplicateCheck(this.root, otherTree.getRoot());
  }

  protected boolean duplicateCheck(TreeNode t1, TreeNode t2) throws NullPointerException
  {
        
    if(t1==null && t2==null)
	  {return true;}
    //if(t1.getItem()==null || t2.getItem()==null)
    //{return false;}
