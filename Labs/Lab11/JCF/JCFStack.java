...
public class JCFStack
{
   public static void main(String[] args) throws CloneNotSupportedException
   {
		...
		System.out.println("Please enter the value you'd like to find: ");
		Integer value =Integer.valueOf(scanny.nextInt());
		int pos = stack1.search(value);
		System.out.println("The 1-based index of "+value+" is "+pos+".");
